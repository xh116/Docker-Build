...
function install_caddy() {
	...
	"${GOBIN}/xcaddy" build --with "github.com/caddyserver/forwardproxy@caddy2=github.com/klzgrad/forwardproxy@naive" --with "github.com/caddyserver/transform-encoder" --with "github.com/imgk/caddy-trojan" --with "github.com/caddy-dns/cloudflare" 
